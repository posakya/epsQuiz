 ...
 */
public class RestaurantsFromKorea extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor cursor = db.getData("restaurant");

        getActivity().setTitle("Restaurants in Korea");
    ...
    public void onResume(){
        ...
        ((MainActivity) getActivity())
                .setActionBarTitle("Restaurants in Korea");
