...
public class InvestorsFromKorea extends Fragment {
   ...
   dbHandler db;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor cursor = db.getData("investor");

        getActivity().setTitle("Investors from Korea");
    ...
    public void onResume(){
        ...
        ((MainActivity) getActivity())
                .setActionBarTitle("Investors from Korea");
