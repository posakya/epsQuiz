 ...
 */
public class ShoppingInKorea extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor cursor = db.getData("shopping");

        getActivity().setTitle("Shopping in Korea");
    ...
    public void onResume(){
        ...
        ((MainActivity) getActivity())
                .setActionBarTitle("Shopping in Korea");
